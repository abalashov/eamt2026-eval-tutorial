...
| File | Contents |
|---|---|
| `source_ja.txt` | English source sentences |
| `reference_ja.txt` | Professional human translation into German |
| `system_1_ja.txt` | Output from a leading commercial NMT engine |
| `system_2_ja.txt` | Output from a local NMT engine |
| `system_3_ja.txt` | Output from an open-weight LLM (large) |
| `system_4_ja.txt` | Output from an open-weight LLM (medium / small) |
...
6. In the BLEU options expand *tokenize* and select `ja-mecab`.
